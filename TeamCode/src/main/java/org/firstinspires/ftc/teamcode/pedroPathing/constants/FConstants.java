...
public class FConstants {
    static {
        ...
        FollowerConstants.mass = 15.422;

        FollowerConstants.xMovement = 56.4535;
        FollowerConstants.yMovement = 43.6226;

        FollowerConstants.forwardZeroPowerAcceleration = -32.6906;
        FollowerConstants.lateralZeroPowerAcceleration = -32.956;
