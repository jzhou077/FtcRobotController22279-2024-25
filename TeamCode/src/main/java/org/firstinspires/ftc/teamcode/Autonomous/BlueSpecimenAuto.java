...
@Autonomous(name="Blue Specimen Auto", group="Autonomous OpModes")
public class BlueSpecimenAuto extends OpMode {
    ...
    private final Pose scorePreloadPose = new Pose(34, 72, Math.toRadians(180)); //1
    private final Pose push1Pose = new Pose(47, 35, Math.toRadians(180)); // 2
    private final Pose push1ControlPose = new Pose(16, 38);
    private final Pose push2Pose = new Pose(60, 26, Math.toRadians(180)); //3
    private final Pose push2ControlPose = new Pose(58, 35);
    private final Pose push3Pose = new Pose(10, 26, Math.toRadians(180)); //4
    private final Pose push4Pose = new Pose(60, 14, Math.toRadians(180)); //5
    private final Pose push4ControlPose = new Pose(65, 36);
    private final Pose push5Pose = new Pose(10, 14, Math.toRadians(180)); //6
    private final Pose prepGrabPose = new Pose(13, 14, Math.toRadians(0)); // 7
    private final Pose reloadPose = new Pose(13, 30, Math.toRadians(0)); // 8
    private final Pose scorePickup1Pose = new Pose(34, 69, Math.toRadians(180)); //9
    private final Pose scorePickup2Pose = new Pose(34, 66, Math.toRadians(180)); // 11
    private final Pose scorePickup3Pose = new Pose(34, 63, Math.toRadians(180)); // 13
